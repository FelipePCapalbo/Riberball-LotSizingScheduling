...
O nível semanal do problema dos balões é um CLSP em máquinas paralelas não relacionadas, com produtividade $p_{ij}$ distinta por par máquina-balão e compatibilidades próprias, ao qual se somam lote mínimo, custo de estoque explícito e três camadas de demanda arbitradas por preço. É essa combinação que distingue o problema do CLSP canônico.
