...
A restrição \eqref{eq:balanco} realiza o balanço de massa do estoque, considerando o estoque do período anterior, a produção atual, e subtraindo a demanda atendida e vendas perdidas.
