...
\begin{frame}{O que o modelo assume e o que ele ainda não trata}
  ...
  re-execução seguinte, em horizonte rolante. E o dado real da fábrica ainda está em base mensal,
  enquanto o contrato dos modelos é semanal.}
\end{frame}

% ---------------------------------------------------------------------------
\begin{frame}{Duas frentes restam até a defesa}
  ...
  \begin{center}
    \begin{ganttchart}[
      ...
      \ganttbar[bar/.append style={fill=laranjaEsc}]{dado real: mensal $\to$ semanal}{2}{4} \\
  ...
  \note{Duas frentes, em trimestres. As frentes de modelagem que estavam nesta lista na revisão
  ...
  A primeira é converter o dado real da fábrica, que está em base mensal, para o contrato semanal
  com carteira de pedidos.

  Depois vem a redação final.}
\end{frame}
